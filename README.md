...
- **Project Setup**: AI helped generate the initial FastAPI skeleton and Pydantic models. I modified the models to include better  descriptions and specific validation logic (FOR EX: adding `caller` to the body to match the spec).
